...
```{r}
# load all the files
s13 = read.csv('data/GSE100227_normalized_data_Supple13.csv')
s13_p = read_excel('data/41467_2021_25583_MOESM9_ESM.xlsx', sheet = 2)
response = read.csv("data/GSE100227_response.csv")
...
```{r}
library(readxl)
s14 = read.csv('data/GSE100227_normalized_data_Supple14.csv')
s14_p = read_excel('data/41467_2021_25583_MOESM9_ESM.xlsx', sheet = 3)
